    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-20 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-900 font-medium">Lingkungan</p>
          ...
          <div>
            ...
            <p className="text-gray-900 font-medium">Pendidikan</p>
            <small className="text-gray-400">
              In publishing and graphic design, Lorem ipsum is a placeholder
              text commonly used to demonstrate the
            </small>
          ...
          <div>
            ...
            <p className="text-gray-900 font-medium">Kesehatan dan Kebugaran</p>
            <small className="text-gray-400">
              In publishing and graphic design, Lorem ipsum is a placeholder
              text commonly used to demonstrate the
            </small>
          ...
          <div>
            ...
            <p className="text-gray-900 font-medium">Bantuan Bencana</p>
            <small className="text-gray-400">
              In publishing and graphic design, Lorem ipsum is a placeholder
              text commonly used to demonstrate the
            </small>
      ...
      <section className="mx-auto max-w-7xl px-5 md:px-20">
        ...
        terbaru
          ...
          Bantu kami untuk membantu orang-orang yang tidak mampu
          </span>
        </h2>
